...
- Test: "If I delete this line, will Claude make a mistake?" — if No, delete it
...
**Conciseness penalty**: If score is 5 or below, cap the total grade at C (max 69) regardless of other criteria. An over-specified CLAUDE.md causes Claude to lose important rules in the noise, reducing overall instruction compliance.
