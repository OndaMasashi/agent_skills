...
1. Read `references/ideas-by-category.md` (vendored copy; upstream lives at `skills/marketing-ideas/references/ideas-by-category.md` in the `marketingskills` repo)
...
- `references/ideas-by-category.md` (vendored from `skills/marketing-ideas/references/` in the `marketingskills` repo)
